...
public class PolyvCloudClassMediaController extends PolyvCommonMediacontroller<PolyvCloudClassVideoView>
        implements IPolyvCloudClassController, View.OnClickListener, PolyvSlideSwitch.OnChangedListener {
...
//                break;
    ...
    public void setDanmuFragment(PolyvFragmentDanmu danmuFragment) {
