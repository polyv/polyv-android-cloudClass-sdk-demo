...
import com.easefun.polyv.cloudclassdemo.view.PolyvFragmentDanmu;
import com.easefun.polyv.commonui.player.IPolyvVideoItem;
import com.easefun.polyv.commonui.player.ppt.PolyvPPTItem;
import com.easefun.polyv.commonui.player.view.PolyvLightTipsView;
import com.easefun.polyv.commonui.player.view.PolyvVolumeTipsView;
...
public class PolyvCloudClassVideoItem extends FrameLayout
    ...
    private PolyvFragmentDanmu danmuFragment;
    ...
    private Runnable hideTask = new Runnable() {
        ...
        public void run() {
            ...
            subBackLand.setVisibility(INVISIBLE);
        }
    };
    ...
    private void showSubLandBack() {
        ...
        subBackLand.setVisibility(VISIBLE);
        if (getHandler() != null) {
            getHandler().removeCallbacks(hideTask);
        }

        postDelayed(hideTask, 5000);
    }
    ...
    private void initialView() {
        ...
        danmuFragment = new PolyvFragmentDanmu();
