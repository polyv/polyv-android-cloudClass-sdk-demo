...
import com.easefun.polyv.cloudclass.chat.PolyvUserManager;
...
public class PolyvSendMessageHolder extends ClickableViewHolder<Object,PolyvChatListAdapter> {
    ...
    private void initiCommonView() {
        avatar = parentView.findViewById(R.id.send_avatar);
    }
    ...
    public   void processCustomMessage(PolyvCustomEvent item, int position) {
        ...
        Glide.with(parentView.getContext())
                .load(PolyvUserManager.getInstance().getAvatar())
                .apply( adapter.getRequestOptions_s())
                .into(avatar);
    }
