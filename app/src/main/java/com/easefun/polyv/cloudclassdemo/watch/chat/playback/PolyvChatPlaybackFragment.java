...
public class PolyvChatPlaybackFragment extends PolyvChatBaseFragment {
    ...
    private void getChatPlaybackList(boolean isAutoRequest, boolean isId) {
        if (getChatPlaybackDisposable != null) {
            getChatPlaybackDisposable.dispose();
        }
        if (!isId) {
    ...
    private void requestSendPlaybackMessageApi(String message, PolyvSendLocalImgEvent localImgEvent, String uploadImgUrl, String imgId, boolean isImgMessage) {
        if (getVideoView() != null) {
