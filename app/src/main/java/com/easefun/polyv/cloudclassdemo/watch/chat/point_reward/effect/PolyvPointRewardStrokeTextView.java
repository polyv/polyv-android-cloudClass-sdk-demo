...
public class PolyvPointRewardStrokeTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public PolyvPointRewardStrokeTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PolyvPointRewardStrokeTextView(Context context, AttributeSet attrs, int defStyle) {
