...
[![GitHub release](https://img.shields.io/badge/release-v0.5.8-blue.svg)](https://github.com/polyv/polyv-android-cloudClass-sdk-demo/releases/tag/v0.5.8)
...
0.5.8版API文档请看[v0.5.8 API](http://repo.polyv.net/android/cloudclass/javadoc/0.5.8/index.html)
