...
[![GitHub release](https://img.shields.io/badge/release-v0.14.0-compatible-blue.svg)](https://github.com/polyv/polyv-android-cloudClass-sdk-demo/releases/tag/v0.14.0-compatible)
...
0.7.1版API文档请看[v0.7.1 API](http://repo.polyv.net/android/cloudclass/javadoc/0.7.1/index.html)

0.7.2版API文档请看[v0.7.2 API](http://repo.polyv.net/android/cloudclass/javadoc/0.7.2/index.html)

0.7.3版API文档请看[v0.7.3 API](http://repo.polyv.net/android/cloudclass/javadoc/0.7.3/index.html)

0.7.4版API文档请看[v0.7.4 API](http://repo.polyv.net/android/cloudclass/javadoc/0.7.4/index.html)

0.7.5版API文档请看[v0.7.5 API](http://repo.polyv.net/android/cloudclass/javadoc/0.7.5/index.html)

0.7.5.1版API文档请看[v0.7.5.1 API](http://repo.polyv.net/android/cloudclass/javadoc/0.7.5.1/index.html)

0.14.0版API文档请看[v0.14.0 API](http://repo.polyv.net/android/cloudclass/javadoc/0.14.0/index.html)

0.14.0-compatible版API文档请看[v0.14.0-compatible API](http://repo.polyv.net/android/cloudclass/javadoc/0.14.0-compatible/index.html)