...
[![GitHub release](https://img.shields.io/badge/release-v0.8.2.02-blue.svg)](https://github.com/polyv/polyv-android-cloudClass-sdk-demo/releases/tag/v0.8.2.02)
...
0.8.1版API文档请看[v0.8.1 API](http://repo.polyv.net/android/cloudclass/javadoc/0.8.1/index.html)

0.8.2.02版API文档请看[v0.8.2.02 API](http://repo.polyv.net/android/cloudclass/javadoc/0.8.2.02/index.html)