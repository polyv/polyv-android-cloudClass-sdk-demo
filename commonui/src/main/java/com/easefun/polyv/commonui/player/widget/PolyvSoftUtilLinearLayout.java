...
public class PolyvSoftUtilLinearLayout extends LinearLayout {
    ...
    public PolyvSoftUtilLinearLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mStatusBarHeight = PolyvControlUtils.getStatusBarHeight(context);
    }

    public PolyvSoftUtilLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mStatusBarHeight = PolyvControlUtils.getStatusBarHeight(context);
    }

    public PolyvSoftUtilLinearLayout(Context context) {
        super(context);
        mStatusBarHeight = PolyvControlUtils.getStatusBarHeight(context);
    }
