 ...
 * @Describe
 */
public class PolyvTouchContainer extends FrameLayout {
    ...
    public PolyvTouchContainer(Context context) {
        this(context,null);
    }

    public PolyvTouchContainer(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public PolyvTouchContainer(Context context, AttributeSet attrs, int defStyleAttr) {
